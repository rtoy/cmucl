...
;;;
(ext:file-comment
  "$Header: /Volumes/share2/src/cmucl/cvs2git/cvsroot/src/code/sap.lisp,v 1.14 1998/02/19 10:52:12 dtc Exp $")
;;;
;;; **********************************************************************
;;;
...
(defun sap+ (sap offset)
  ...
  (declare (type system-area-pointer sap)
	   #+(or x86 sparc) (fixnum offset) #-(or x86 sparc) (type index offset))
  (sap+ sap offset))
...
(defun sap-ref-8 (sap offset)
  ...
  (declare (type system-area-pointer sap)
	   #+(or x86 sparc) (fixnum offset)
	   #-(or x86 sparc) (type index offset))
