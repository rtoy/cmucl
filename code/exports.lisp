...
;;;
(ext:file-comment
  "$Header: /Volumes/share2/src/cmucl/cvs2git/cvsroot/src/code/exports.lisp,v 1.130 1997/11/01 22:58:11 dtc Exp $")
;;;
;;; **********************************************************************
;;;
...
(defpackage #+pmax "PMAX" #+sparc "SPARC" #+ibmrt "RT"
  ...
  (:export "*ASSEMBLY-UNIT-LENGTH*" "*PRIMITIVE-OBJECTS*"
	   ...
	   "DESCRIPTOR-REG-SC-NUMBER" "DESCRIPTOR-STACK-SC-NUMBER"
	   ...
	   "DOUBLE-STACK-SC-NUMBER" "DWORD-REG-SC-NUMBER"
	   "DYLAN-FUNCTION-HEADER-TYPE" "ERROR-TRAP"
	   "EVEN-FIXNUM-TYPE" "EXPORTED-STATIC-SYMBOLS" "EXTERN-ALIEN-NAME"
	   ...
	   "FP-DOUBLE-CONSTANT-SC-NUMBER" "FP-DOUBLE-ZERO-SC-NUMBER"
	   "FP-SINGLE-CONSTANT-SC-NUMBER" "FP-SINGLE-ZERO-SC-NUMBER"
...
(defpackage "KERNEL"
  ...
  (:export "%ACOS" "%ACOSH" "%ARRAY-AVAILABLE-ELEMENTS"
	   ...
	   "CODE-INSTRUCTIONS" "COMPLEX-SINGLE-FLOAT-P" 
	   "COMPLEX-DOUBLE-FLOAT-P" "CONSED-SEQUENCE" "CONSTANT-TYPE"
	   ...
	   "OBJECT-NOT-COMPLEX-ERROR" "OBJECT-NOT-COMPLEX-SINGLE-FLOAT-ERROR"
	   "OBJECT-NOT-COMPLEX-DOUBLE-FLOAT-ERROR" "OBJECT-NOT-CONS-ERROR"
...
(defpackage "MULTIPROCESSING"
  (:use "COMMON-LISP")
  (:nicknames "MP")
  (:export "INIT-STACK-GROUPS" "MAKE-STACK-GROUP" "STACK-GROUP-RESUME"
	   "*CURRENT-STACK-GROUP*" "*INITIAL-STACK-GROUP*"
	   "*MULTI-PROCESSING*" "*CURRENT-PROCESS*" "*ALL-PROCESSES*"
	   "ALL-PROCESSES" "CURRENT-PROCESS"
	   "MAKE-PROCESS" "PROCESSP" "PROCESS-STATE" "PROCESS-WHOSTATE"
	   "PROCESS-NAME" "DESTROY-PROCESS" "PROCESS-WAIT"
	   "PROCESS-WAIT-WITH-TIMEOUT" "PROCESS-YIELD"
	   "PROCESS-INTERRUPT" "DISABLE-PROCESS" "ENABLE-PROCESS"
	   "RESTART-PROCESS" "PROCESS-PRESET"
	   "WITHOUT-SCHEDULING" "SHOW-PROCESSES"
	   "PROCESS-ACTIVE-P" "PROCESS-ALIVE-P"
