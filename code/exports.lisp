...
;;;
(ext:file-comment
  "$Header: /Volumes/share2/src/cmucl/cvs2git/cvsroot/src/code/exports.lisp,v 1.277 2008/12/31 00:52:50 rtoy Exp $")
;;;
;;; **********************************************************************
;;;
...
(defpackage "EXTENSIONS"
  ...
  (:export   "*AFTER-GC-HOOKS*" "*AFTER-SAVE-INITIALIZATIONS*"
	     ...
	     "COMPILER-MACROEXPAND-1" "COMPILER-MACROEXPAND"
             ...
             "COMPLETE-FILE" "CONCAT-PNAMES"
             "CONSTANT" "CONSTANT-ARGUMENT" "CONSTANT-FUNCTION"
	     "DEF-SOURCE-CONTEXT"
             "DEFAULT-DIRECTORY"
             "DEFINE-HASH-CACHE" "DEFINE-INFO-CLASS"
             "DEFINE-INFO-TYPE"
             "DEFMODULE" "DEFUN-CACHED"
             "DELETEF" "DELQ"
             "DO-ANONYMOUS" "DO-INFO"
             "DOVECTOR"
	     ...
	     "GET-STREAM-COMMAND"
             "INDENTING-FURTHER" "INFO"
             "INHIBIT-WARNINGS" "INTERACTIVE-EVAL"
             "ITERATE"
             "LETF" "LETF*" "LISTEN-SKIP-WHITESPACE"
             "LOAD-FOREIGN"
	     ...
	     "UNLOCK-ALL-PACKAGES"
             ...
             "READ-CHAR-NO-EDIT" "REALP"
             "REQUIRED-ARGUMENT" "RESET-FOREIGN-POINTERS"
             "SAVE" "SAVE-LISP"
