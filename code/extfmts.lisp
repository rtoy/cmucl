...
;;; 
(ext:file-comment
 "$Header: /Volumes/share2/src/cmucl/cvs2git/cvsroot/src/code/extfmts.lisp,v 1.2.4.3.2.21 2009/05/20 21:47:36 rtoy Exp $")
;;;
;;; **********************************************************************
;;;
...
(defun load-external-format-aliases ()
  (let ((*package* (find-package "KEYWORD"))
    ...
    (with-open-file (stm "ext-formats:aliases" :if-does-not-exist nil :external-format :iso8859-1)
      (when stm
