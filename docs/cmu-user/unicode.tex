...
characters are actually UTF-16 code-units.
...
For files, \code{WITH-OPEN-FILE} takes the \kwd{external-format}
parameter to specify the format.  The default external format is,
naturally, specified by \var{*default-external-format*}.
...
\begin{defun}{}{char-equal}{\amprest{} \var{characters}}
   ...
   For the comparison, the characters are converted to uppercase and
...
\begin{defun}{}{char-upcase}{\args \var{character}}
  \defunx{char-downcase}{\args \var{characters}}
...
\begin{defun}{}{string-upcase}{\args \var{string} \keys{\kwd{start}
      \kwd{end}}}
  \defunx{string-downcase}{\args \var{string} \keys{\kwd{start} \kwd{end}}}
  \defunx{string-capitalize}{\args \var{string} \keys{\kwd{start} \kwd{end}}}
  \defunx{nstring-upcase}{\args \var{string} \keys{\kwd{start} \kwd{end}}}
...
\begin{defun}{}{string-equal}{\args \var{s1} \var{s2} \keys{\kwd{start1}
  ...
  The individual characters of the strings are compared as appropriate
  to determine the result.  Each codepoint in the string is converted
  to uppercase and the appropriate comparison of the codepoint values
  are done.  Unicode collation is not done.
\end{defun}
...
\begin{defmac}[base]{stream:}{define-external-format}{\args \var{name}
    ...
    \morekeys{\ampoptional{} \var{octets-to-code} \var{code-to-octets}}}
