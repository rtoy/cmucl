...
;;; domain.
;;;
(ext:file-comment "$Header: /Volumes/share2/src/cmucl/cvs2git/cvsroot/src/pcl/simple-streams/external-formats/mac-icelandic.lisp,v 1.1.2.1 2008/07/02 01:22:10 rtoy Exp $")

(defconstant +mac-icelandic+
  (make-array 128 :element-type '(unsigned-byte 16)
     :initial-contents #(196 197 199 201 209 214 220 225 224 226 228 227 229
                         ...
                         246 245 250 249 251 252 221 176 162 163 167 8226 182
                         ...
                         9674 255 376 8260 164 208 240 222 254 253 183 8218
