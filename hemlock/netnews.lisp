...
(bind-key "Netnews Message Select Headers Buffer" #k"hyper-h"
	  :mode "News-Message")
(bind-key "Netnews Message Select Headers Buffer" #k"^" :mode "News-Message")
...
(bind-key "Netnews Message Punt" #k"q" :mode "News-Message")
...
(bind-key "List All Newsgroups" #k"l" :mode "News-Headers")
(bind-key "List All Newsgroups" #k"l" :mode "News-Message")
(bind-key "Netnews Append to File" #k"a" :mode "News-Headers")
(bind-key "Netnews Append to File" #k"a" :mode "News-Message")
(bind-key "Netnews Post Message" #k"s" :mode "News-Headers")
(bind-key "Netnews Post Message" #k"s" :mode "News-Message")
(bind-key "Netnews Reply to Message" #k"r" :mode "News-Headers")
(bind-key "Netnews Reply to Message in Other Window" #k"r"
	  :mode "News-Message")
(bind-key "netnews Reply to Message in Other Window" #k"R"
	  :mode "News-Headers")
(bind-key "Netnews Reply via Mail" #k"m" :mode "News-Headers") ; 
(bind-key "Netnews Reply via Mail" #k"m" :mode "News-Message")
...
(bind-key "Netnews Message Select Post Buffer" #k"hyper-p"
	  :mode "News-Message")
(bind-key "Netnews Message Select Draft Buffer" #k"hyper-d"
	  :mode "News-Message")
...
(bind-key "Netnews Punt Headers" #k"Hyper-p" :mode "News-Headers")


(bind-key "Netnews Quit Browse" #k"q" :mode "News-Browse")
(bind-key "Netnews Browse Add Newsgroup To File" #k"a"
	  :mode "News-Browse")
