...
;;;
(ext:file-comment
  "$Header: /Volumes/share2/src/cmucl/cvs2git/cvsroot/src/compiler/mips/type-vops.lisp,v 1.33 1992/03/11 21:26:52 wlott Exp $")
;;;
;;; **********************************************************************
;;;
...
(define-vop (fdefn-p simple-type-predicate)
  (:variant fdefn-type)
  (:variant-cost 9)
  (:translate fdefn-p))
