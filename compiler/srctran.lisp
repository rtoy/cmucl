...
;;;
(ext:file-comment
  "$Header: /Volumes/share2/src/cmucl/cvs2git/cvsroot/src/compiler/srctran.lisp,v 1.170.12.1 2010/02/08 17:15:51 rtoy Exp $")
;;;
;;; **********************************************************************
;;;
  ...
  (if (eq (numeric-type-complexp type) :complex)
      ...
      (let* ((type-interval (numeric-type->interval type))
	     ...
	     (zero (if (eq (numeric-type-class type) 'float)
			 ...
			 #+double-double
			 (double-double-float
			  (specifier-type '(double-double-float -0w0 0w0)))
			 ((nil)
