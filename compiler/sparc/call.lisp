...
(defconstant number-stack-displacement
  (* (+ 16 ; 16 words to save ins and locals in.
	1  ; extra word required by C call convention.
	6  ; space where anyone we call can save his args.
	1) ; and one more to round it out.
     vm:word-bytes))
