/*
 * $Header: /Volumes/share2/src/cmucl/cvs2git/cvsroot/src/ldb/Attic/dynbind.c,v 1.1 1990/03/29 02:55:05 ch Exp $
 * 
...
lispobj symbol, value;
{
	...
	current_binding_stack_pointer += (sizeof(binding) / sizeof(lispobj));
